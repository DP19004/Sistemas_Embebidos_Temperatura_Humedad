...
@section('title','Gestionar | Cultivos')
@section('content')
...
<br>
<h1 class="display-4 text-center">Gestionar Cultivos</h1>
                ...
                <tr>
                    ...
                    <td>
                     <form action="{{ route ('cultivos.destroy',$cultivo->id)}}" method="POST">
                      <a href="/cultivos/{{$cultivo->id}}/edit" class="btn btn-info" title="Edita el cultivo">
                      ...
                      @csrf
                      @method('DELETE')
                      <button type="submit"class="btn btn-danger" title="Elimina el cultivo">
